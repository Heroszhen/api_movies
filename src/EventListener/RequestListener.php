    ...
    public function onKernelResponse(ResponseEvent $event): void
    {
        ...
        if ('test' !== $_ENV['APP_ENV']) {
            ...
            $contentSecurityPolicy = [
                ...
                'connect-src' => "connect-src XMLHttpRequest WebSockets EventSource cdn.cookielaw.org data: static.addtoany.com privacyportal-eu.onetrust.com cm.teads.tv t.teads.tv www.google.com {$_ENV['RQST_CTXT_HOST']} {$domains}",
                ...
                'img-src' => "img-src images www.nutella.com sogec-marketing.web.oxv.fr www.static.ferrero.com data: cdn.cookielaw.org www.facebook.com cm.teads.tv www.kinder.com t.teads.tv ad.doubleclick.net www.googletagmanager.com {$_ENV['RQST_CTXT_HOST']} {$domains}",
